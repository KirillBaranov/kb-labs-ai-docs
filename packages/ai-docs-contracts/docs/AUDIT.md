# Package Architecture Audit: @kb-labs/ai-docs-contracts
...
**@kb-labs/ai-docs-contracts** is a well-architected contracts package. The package provides contracts for AI Docs with contract manifest, Zod schemas, TypeScript types, and helper parsers. Key strengths include clean contract definition, schema-first approach, and comprehensive type coverage.
...
Provides public contracts for AI Docs.
