...
const contractsDir = new URL('../ai-docs-contracts/src/', import.meta.url).pathname;
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@kb-labs/ai-docs-contracts': contractsDir + 'index.ts',
      '@kb-labs/ai-docs-contracts/*': contractsDir + '*',
